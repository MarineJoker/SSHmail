			...
			<div class="header_container">
				...
				<div class="top_bar clear">
					...
					<ul class="top_links fr">
						<li class="highlight"><a href="${pageContext.request.contextPath}\public\index.jsp">首页</a></li>
						<li><a href="${pageContext.request.contextPath}\main\aindex.jsp">我的账户</a></li>
                                <li><a href="showCart">购物车</a></li>
                                <li><a href="\WEB-INF\register.jsp">注册</a></li>
                                <li ><a href="${pageContext.request.contextPath}\WEB-INF\ulogin.jsp">登录</a></li>
					</ul>
					<!--头部小导航结束-->
					<!-- logo -->
