            ...
            <div class="header_container">
                ...
                <div class="top_bar clear">
                    ...
                    <ul class="top_links fr">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}\main\aindex.jsp">我的账户</a>
                        </li>
                        <li class="highlight">
                ...
                <div class="pro-check check ">
	                ...
	                <table class="data-table cart-table" cellpadding="0" cellspacing="0">
						...
						<tr lang="${sorder.product1.id}">
							...
							<td width="80px"><img src="${pageContext.request.contextPath}/pageimage/${sorder.product1.pic}" width="80"
								height="80" />
							</td>
                ...
                <form action="forder_save.action" method="post">
	                <div class="person-check check">
	                    ...
	                    <div class="person-checkinner">
	                        ...
	                        <div>
	                        	<label>区域邮编:</label>
	                        	<input type="text" name="post" value="${sessionScope.forder.post }"/>
	                        </div>
	                        <div>
	                        	<label>配送地址:</label>
