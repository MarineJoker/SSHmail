  ...
  <body>
  	<div class="wrapper">
                ...
                <!--头部开始-->
                        <div class="top_bar clear">
                            ...
                            <ul class="top_links fr">
                                ...
                                <li><a href="${pageContext.request.contextPath}\main\aindex.jsp">我的账户</a></li>
                                <li><a href="user\showCart.jsp">购物车</a></li>
                                <li><a href="register.jsp">注册</a></li>
                                <li ><a href="#">登录</a></li>
                            </ul>
                            <!--头部小导航结束-->
                            <!-- logo -->
                            <h1 class="logo clear fl"> <a href="index.html"><img src="${pageContext.request.contextPath}\images\logo.png" /></a> </h1>
                            <!-- 购物车 -->
                            <div class="minicart">
        ...
        <div class="section_container">
            ...
            <!-- 右侧焦点图区域 -->
            <div id="main_content ">
                <div > <img src="${pageContext.request.contextPath}\images\lm_banner_1.jpg" /> </div>
            </div>
        </div>
            ...
            <c:forEach items="${applicationScope.bigList}" var="list">
	            <div class="products_list products_slider clear">
	            	<!-- 显示类别名称 -->
	                <h2 class="sub_title">${list[0].employee1.type}</h2>
	                <ul id="first-carousel" class="first-and-second-carousel jcarousel-skin-tango">
	                    <c:forEach items="${list }" var="product">
		                    <li> 
		                    	<a href="${shop}/product_get.action?id=${product.id}" class="product_image"><img src="file/pageimage/${product.pic}" /></a>
