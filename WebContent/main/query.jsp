    ...
    <script type="text/javascript">  
        $(function(){  
            $('#dg').datagrid({     
                ...
                pageList:[5,10,15,20],  
                idField:'eid',//指定id为标识字段，在删除，更新的时候有用，如果配置此字段，在翻页时，换页不会影响选中的项  
                ...
                toolbar: [{  
                    ...
                    handler: function(){  
                    	parent.$("#win").window({ //因为<div>放在了aindex.jsp中，所以这里创建窗口要先调用parent  
                            ...
                            width:350,  
                            height:150,  
                            content:'<iframe src="send_main_save.action" frameborder="0" width="100%" height="100%"/>'  
                        });  
                    }  
                },'-',{  
                    iconCls: 'icon-edit',  
                    ...
                    handler: function(){  
                         ...
                         if(rows.length == 0) {  
                             ...
                             parent.$("#win").window({  
                                 ...
                                 width:350,  
                                 height:250,  
                                 content:'<iframe src="send_main_update.action" frameborder="0" width="100%" height="100%"/>'  
                             });  
                             //2.   
                         }  
                    }  
                ...
                {field:'hot',title:'热卖',width:100,  //字段hot
                    ...
                    {field:'account1.login',title:'所属管理员',width:200,
                    	formatter:function(value,row,index){
                    		if(row.account1!=null&&row.account1.login!=null){
                    			return row.account1.login;
                    		}else{
                    			return "此类没有管理员";
                    		}
                    		}
