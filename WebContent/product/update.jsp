	...
	<script type="text/javascript">
		$(function(){
			...
			$("#ff").form('load',{
				...
				open1:rows[0].open1,
				'employee1.eid':rows[0].employee1.eid //EasyUI不支持account.id这种点操作，所以要加个引号
			});
  	...
  	<form title="更新商品" id="ff" method="post" enctype="multipart/form-data">
		...
		<div>   
	        <label for="account">所属商品类:</label>
	         <!-- 远程加载管理员数据 -->
	         <input id="cc" name="employee1.eid" />
	    </div>
		<div>
		...
		<div>
			<label for="open1">有效商品:</label>
			上架:<input type="radio" name="open1" value="true" />
			下架:<input type="radio" name="open1" value="false" />
